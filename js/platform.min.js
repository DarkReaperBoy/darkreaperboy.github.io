(function () {
    ...
    function k(a) {
        ...
        var p = n.navigator || {},
            q = p.userAgent || "";
        a || (a = q);
        var r, t, u = o ? !!p.likeChrome : /\bChrome\b/.test(a) && !/internal|\n/i.test(w.toString()),
            v = "Object",
        ...
        }), (r = /\b(?:AMD|IA|Win|WOW|x86_|x)64\b/i.exec(I)) && !/\bi686\b/i.test(I) ? (R && (R.architecture = 64, R.family = R.family.replace(RegExp(" *" + r), "")), O && (/\bWOW64\b/i.test(a) || L && /\w(?:86|32)$/.test(p.cpuClass || p.platform) && !/\bWin64; x64\b/i.test(a)) && J.unshift("32-bit")) : R && /^OS X/.test(R.family) && "Chrome" == O && 39 <= parseFloat(M) && (R.architecture = 64), a || (a = null);
        var S = {};
        return S.description = a, S.layout = N && N[0], S.manufacturer = Q, S.name = O, S.prerelease = K, S.product = P, S.ua = a, S.version = O && M, S.os = R || {
            architecture: null,
            family: null,
            version: null,
            toString: function () {
        ...
        }, S.parse = k, S.toString = function () {
            return this.description || ""
        }, S.version && J.unshift(M), S.name && J.unshift(O), R && O && !(R == (R + "").split(" ")[0] && (R == O.split(" ")[0] || P)) && J.push(P ? "(" + R + ")" : "on " + R), J.length && (S.description = J.join(" ")), S
    }
    var l = {
            function: !0,
            object: !0
