function fn() {
	...
	j.addColorStop(.025, "#fff"),
	j.addColorStop(.1, "hsl(" +hue+", 61%, 33%)"),
	j.addColorStop(.25, "hsl(" +hue+", 64%, 6%)"),
	j.addColorStop(1, "transparent"),
	f.fillStyle=j,
	f.beginPath(),
	f.arc(g, g, g, 0, 2*Math.PI),
	f.fill();

	var k=function() {
		this.orbitRadius=a(b(w, h)),
		this.radius=a(60, this.orbitRadius)/12,
		this.orbitX=w/2,
		this.orbitY=h/2,
		this.timePassed=a(0, maxStars),
		this.speed=a(this.orbitRadius)/9e5,
		this.alpha=a(2, 10)/10,
		count++,
		stars[count]=this
	}
